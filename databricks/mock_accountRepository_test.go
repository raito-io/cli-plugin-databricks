...
func (_m *mockAccountRepository) GetWorkspaceMap(ctx context.Context, metastores []catalog.MetastoreInfo, workspaces []repo.Workspace) (map[string][]string, map[string]string, error) {
...
func (_c *mockAccountRepository_GetWorkspaceMap_Call) Run(run func(ctx context.Context, metastores []catalog.MetastoreInfo, workspaces []repo.Workspace)) *mockAccountRepository_GetWorkspaceMap_Call {
...
func (_c *mockAccountRepository_GetWorkspaceMap_Call) RunAndReturn(run func(context.Context, []catalog.MetastoreInfo, []repo.Workspace) (map[string][]string, map[string]string, error)) *mockAccountRepository_GetWorkspaceMap_Call {
	_c.Call.Return(run)
	return _c
}

// GetWorkspaces provides a mock function with given fields: ctx
func (_m *mockAccountRepository) GetWorkspaces(ctx context.Context) ([]repo.Workspace, error) {
	ret := _m.Called(ctx)
...
func (_c *mockAccountRepository_GetWorkspaces_Call) Return(_a0 []repo.Workspace, _a1 error) *mockAccountRepository_GetWorkspaces_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockAccountRepository_GetWorkspaces_Call) RunAndReturn(run func(context.Context) ([]repo.Workspace, error)) *mockAccountRepository_GetWorkspaces_Call {
	_c.Call.Return(run)
	return _c
}
