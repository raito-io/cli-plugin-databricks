...
func (_m *mockDataSourceWorkspaceRepository) ListFunctions(ctx context.Context, catalogName string, schemaName string) ([]FunctionInfo, error) {
	ret := _m.Called(ctx, catalogName, schemaName)

	var r0 []FunctionInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) ([]FunctionInfo, error)); ok {
		return rf(ctx, catalogName, schemaName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) []FunctionInfo); ok {
		r0 = rf(ctx, catalogName, schemaName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]FunctionInfo)
		}
	}
...
func (_c *mockDataSourceWorkspaceRepository_ListFunctions_Call) Return(_a0 []FunctionInfo, _a1 error) *mockDataSourceWorkspaceRepository_ListFunctions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockDataSourceWorkspaceRepository_ListFunctions_Call) RunAndReturn(run func(context.Context, string, string) ([]FunctionInfo, error)) *mockDataSourceWorkspaceRepository_ListFunctions_Call {
	_c.Call.Return(run)
	return _c
}
