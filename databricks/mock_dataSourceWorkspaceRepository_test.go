...
func (_m *mockDataSourceWorkspaceRepository) ListFunctions(ctx context.Context, catalogName string, schemaName string) ([]catalog.FunctionInfo, error) {
...
func (_c *mockDataSourceWorkspaceRepository_ListFunctions_Call) Return(_a0 []catalog.FunctionInfo, _a1 error) *mockDataSourceWorkspaceRepository_ListFunctions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockDataSourceWorkspaceRepository_ListFunctions_Call) RunAndReturn(run func(context.Context, string, string) ([]catalog.FunctionInfo, error)) *mockDataSourceWorkspaceRepository_ListFunctions_Call {
	_c.Call.Return(run)
	return _c
}
