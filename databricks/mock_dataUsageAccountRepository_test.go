...
func (_c *mockDataUsageAccountRepository_GetWorkspaceMap_Call) Run(run func(ctx context.Context, metastores []catalog.MetastoreInfo, workspaces []provisioning.Workspace)) *mockDataUsageAccountRepository_GetWorkspaceMap_Call {
...
func (_m *mockDataUsageAccountRepository) GetWorkspaces(ctx context.Context) ([]provisioning.Workspace, error) {
	ret := _m.Called(ctx)
...
func (_c *mockDataUsageAccountRepository_GetWorkspaces_Call) Return(_a0 []provisioning.Workspace, _a1 error) *mockDataUsageAccountRepository_GetWorkspaces_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockDataUsageAccountRepository_GetWorkspaces_Call) RunAndReturn(run func(context.Context) ([]provisioning.Workspace, error)) *mockDataUsageAccountRepository_GetWorkspaces_Call {
	_c.Call.Return(run)
	return _c
}
