...
func (_m *mockDataAccessAccountRepository) GetWorkspaceMap(ctx context.Context, metastores []catalog.MetastoreInfo, workspaces []repo.Workspace) (map[string][]string, map[string]string, error) {
...
func (_c *mockDataAccessAccountRepository_GetWorkspaceMap_Call) Run(run func(ctx context.Context, metastores []catalog.MetastoreInfo, workspaces []repo.Workspace)) *mockDataAccessAccountRepository_GetWorkspaceMap_Call {
...
func (_c *mockDataAccessAccountRepository_GetWorkspaceMap_Call) RunAndReturn(run func(context.Context, []catalog.MetastoreInfo, []repo.Workspace) (map[string][]string, map[string]string, error)) *mockDataAccessAccountRepository_GetWorkspaceMap_Call {
	_c.Call.Return(run)
	return _c
}

// GetWorkspaces provides a mock function with given fields: ctx
func (_m *mockDataAccessAccountRepository) GetWorkspaces(ctx context.Context) ([]repo.Workspace, error) {
	ret := _m.Called(ctx)
...
func (_c *mockDataAccessAccountRepository_GetWorkspaces_Call) Return(_a0 []repo.Workspace, _a1 error) *mockDataAccessAccountRepository_GetWorkspaces_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockDataAccessAccountRepository_GetWorkspaces_Call) RunAndReturn(run func(context.Context) ([]repo.Workspace, error)) *mockDataAccessAccountRepository_GetWorkspaces_Call {
	_c.Call.Return(run)
	return _c
}

// ListGroups provides a mock function with given fields: ctx, optFn
func (_m *mockDataAccessAccountRepository) ListGroups(ctx context.Context, optFn ...func(*repo.DatabricksGroupsFilter)) <-chan interface{} {
	...
	if rf, ok := ret.Get(0).(func(context.Context, ...func(*repo.DatabricksGroupsFilter)) <-chan interface{}); ok {
		r0 = rf(ctx, optFn...)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
//   - optFn ...func(*repo.DatabricksGroupsFilter)
...
func (_c *mockDataAccessAccountRepository_ListGroups_Call) Run(run func(ctx context.Context, optFn ...func(*repo.DatabricksGroupsFilter))) *mockDataAccessAccountRepository_ListGroups_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*repo.DatabricksGroupsFilter), len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
				variadicArgs[i] = a.(func(*repo.DatabricksGroupsFilter))
			}
		}
...
func (_c *mockDataAccessAccountRepository_ListGroups_Call) RunAndReturn(run func(context.Context, ...func(*repo.DatabricksGroupsFilter)) <-chan interface{}) *mockDataAccessAccountRepository_ListGroups_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *mockDataAccessAccountRepository) ListUsers(ctx context.Context, optFn ...func(*repo.DatabricksUsersFilter)) <-chan interface{} {
	_va := make([]interface{}, len(optFn))
	for _i := range optFn {
		_va[_i] = optFn[_i]
	}
	...
	var r0 <-chan interface{}
	if rf, ok := ret.Get(0).(func(context.Context, ...func(*repo.DatabricksUsersFilter)) <-chan interface{}); ok {
		r0 = rf(ctx, optFn...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan interface{})
...
//   - ctx context.Context
//   - optFn ...func(*repo.DatabricksUsersFilter)
...
func (_c *mockDataAccessAccountRepository_ListUsers_Call) Run(run func(ctx context.Context, optFn ...func(*repo.DatabricksUsersFilter))) *mockDataAccessAccountRepository_ListUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*repo.DatabricksUsersFilter), len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
				variadicArgs[i] = a.(func(*repo.DatabricksUsersFilter))
			}
		}
		run(args[0].(context.Context), variadicArgs...)
	})
...
func (_c *mockDataAccessAccountRepository_ListUsers_Call) RunAndReturn(run func(context.Context, ...func(*repo.DatabricksUsersFilter)) <-chan interface{}) *mockDataAccessAccountRepository_ListUsers_Call {
	_c.Call.Return(run)
	return _c
}
