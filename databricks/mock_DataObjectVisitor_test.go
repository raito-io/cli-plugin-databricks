...
// VisitMetastore provides a mock function with given fields: ctx, metastore, workspace
func (_m *MockDataObjectVisitor) VisitMetastore(ctx context.Context, metastore *catalog.MetastoreInfo, workspace *provisioning.Workspace) error {
	ret := _m.Called(ctx, metastore, workspace)
...
//   - workspace *provisioning.Workspace
func (_e *MockDataObjectVisitor_Expecter) VisitMetastore(ctx interface{}, metastore interface{}, workspace interface{}) *MockDataObjectVisitor_VisitMetastore_Call {
	return &MockDataObjectVisitor_VisitMetastore_Call{Call: _e.mock.On("VisitMetastore", ctx, metastore, workspace)}
}

func (_c *MockDataObjectVisitor_VisitMetastore_Call) Run(run func(ctx context.Context, metastore *catalog.MetastoreInfo, workspace *provisioning.Workspace)) *MockDataObjectVisitor_VisitMetastore_Call {
	_c.Call.Run(func(args mock.Arguments) {
