...
func (_m *mockDataAccessWorkspaceRepository) ListFunctions(ctx context.Context, catalogName string, schemaName string) ([]FunctionInfo, error) {
...
func (_c *mockDataAccessWorkspaceRepository_ListFunctions_Call) Return(_a0 []FunctionInfo, _a1 error) *mockDataAccessWorkspaceRepository_ListFunctions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockDataAccessWorkspaceRepository_ListFunctions_Call) RunAndReturn(run func(context.Context, string, string) ([]FunctionInfo, error)) *mockDataAccessWorkspaceRepository_ListFunctions_Call {
	_c.Call.Return(run)
	return _c
}
