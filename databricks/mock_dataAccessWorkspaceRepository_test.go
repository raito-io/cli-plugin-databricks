...
// GetCatalogWorkspaceBinding provides a mock function with given fields: ctx, catalogName
func (_m *mockDataAccessWorkspaceRepository) GetCatalogWorkspaceBinding(ctx context.Context, catalogName string) (*catalog.WorkspaceBinding, error) {
	ret := _m.Called(ctx, catalogName)

	if len(ret) == 0 {
		panic("no return value specified for GetCatalogWorkspaceBinding")
	}

	var r0 *catalog.WorkspaceBinding
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*catalog.WorkspaceBinding, error)); ok {
		return rf(ctx, catalogName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *catalog.WorkspaceBinding); ok {
...
// mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCatalogWorkspaceBinding'
type mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call struct {
	*mock.Call
}

// GetCatalogWorkspaceBinding is a helper method to define mock.On call
//   - ctx context.Context
//   - catalogName string
func (_e *mockDataAccessWorkspaceRepository_Expecter) GetCatalogWorkspaceBinding(ctx interface{}, catalogName interface{}) *mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call {
	return &mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call{Call: _e.mock.On("GetCatalogWorkspaceBinding", ctx, catalogName)}
}

func (_c *mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call) Run(run func(ctx context.Context, catalogName string)) *mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call {
...
func (_c *mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call) Return(_a0 *catalog.WorkspaceBinding, _a1 error) *mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call) RunAndReturn(run func(context.Context, string) (*catalog.WorkspaceBinding, error)) *mockDataAccessWorkspaceRepository_GetCatalogWorkspaceBinding_Call {
	_c.Call.Return(run)
	return _c
}
