...
func (_m *MockWarehouseRepository) ExecuteStatement(ctx context.Context, catalog string, schema string, statement string, parameters ...sql.StatementParameterListItem) (*sql.StatementResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, ...sql.StatementParameterListItem) (*sql.StatementResponse, error)); ok {
		return rf(ctx, catalog, schema, statement, parameters...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, ...sql.StatementParameterListItem) *sql.StatementResponse); ok {
...
func (_c *MockWarehouseRepository_ExecuteStatement_Call) Return(_a0 *sql.StatementResponse, _a1 error) *MockWarehouseRepository_ExecuteStatement_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWarehouseRepository_ExecuteStatement_Call) RunAndReturn(run func(context.Context, string, string, string, ...sql.StatementParameterListItem) (*sql.StatementResponse, error)) *MockWarehouseRepository_ExecuteStatement_Call {
	_c.Call.Return(run)
	return _c
}

// GetTableInformation provides a mock function with given fields: ctx, catalog, schema, tableName
func (_m *MockWarehouseRepository) GetTableInformation(ctx context.Context, catalog string, schema string, tableName string) (map[string]*types.ColumnInformation, error) {
	...
	var r0 map[string]*types.ColumnInformation
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) (map[string]*types.ColumnInformation, error)); ok {
		return rf(ctx, catalog, schema, tableName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) map[string]*types.ColumnInformation); ok {
		r0 = rf(ctx, catalog, schema, tableName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]*types.ColumnInformation)
		}
	}
...
func (_c *MockWarehouseRepository_GetTableInformation_Call) Return(_a0 map[string]*types.ColumnInformation, _a1 error) *MockWarehouseRepository_GetTableInformation_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWarehouseRepository_GetTableInformation_Call) RunAndReturn(run func(context.Context, string, string, string) (map[string]*types.ColumnInformation, error)) *MockWarehouseRepository_GetTableInformation_Call {
	_c.Call.Return(run)
	return _c
}

// GetTags provides a mock function with given fields: ctx, catalog, fn
func (_m *MockWarehouseRepository) GetTags(ctx context.Context, catalog string, fn func(context.Context, string, string, string) error) error {
	ret := _m.Called(ctx, catalog, fn)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, func(context.Context, string, string, string) error) error); ok {
		r0 = rf(ctx, catalog, fn)
	} else {
		r0 = ret.Error(0)
	}
...
// MockWarehouseRepository_GetTags_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTags'
type MockWarehouseRepository_GetTags_Call struct {
	*mock.Call
}
...
func (_e *MockWarehouseRepository_Expecter) GetTags(ctx interface{}, catalog interface{}, fn interface{}) *MockWarehouseRepository_GetTags_Call {
	return &MockWarehouseRepository_GetTags_Call{Call: _e.mock.On("GetTags", ctx, catalog, fn)}
}

func (_c *MockWarehouseRepository_GetTags_Call) Run(run func(ctx context.Context, catalog string, fn func(context.Context, string, string, string) error)) *MockWarehouseRepository_GetTags_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(func(context.Context, string, string, string) error))
	})
	return _c
}

func (_c *MockWarehouseRepository_GetTags_Call) Return(_a0 error) *MockWarehouseRepository_GetTags_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWarehouseRepository_GetTags_Call) RunAndReturn(run func(context.Context, string, func(context.Context, string, string, string) error) error) *MockWarehouseRepository_GetTags_Call {
	_c.Call.Return(run)
	return _c
}
