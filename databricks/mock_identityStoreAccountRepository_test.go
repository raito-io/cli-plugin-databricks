...
func (_m *mockIdentityStoreAccountRepository) ListGroups(ctx context.Context, optFn ...func(*repo.DatabricksGroupsFilter)) <-chan interface{} {
...
func (_c *mockIdentityStoreAccountRepository_ListGroups_Call) Run(run func(ctx context.Context, optFn ...func(*repo.DatabricksGroupsFilter))) *mockIdentityStoreAccountRepository_ListGroups_Call {
...
func (_c *mockIdentityStoreAccountRepository_ListGroups_Call) RunAndReturn(run func(context.Context, ...func(*repo.DatabricksGroupsFilter)) <-chan interface{}) *mockIdentityStoreAccountRepository_ListGroups_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *mockIdentityStoreAccountRepository_ListUsers_Call) Run(run func(ctx context.Context, optFn ...func(*repo.DatabricksUsersFilter))) *mockIdentityStoreAccountRepository_ListUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockIdentityStoreAccountRepository_ListUsers_Call) RunAndReturn(run func(context.Context, ...func(*repo.DatabricksUsersFilter)) <-chan interface{}) *mockIdentityStoreAccountRepository_ListUsers_Call {
	_c.Call.Return(run)
	return _c
}
