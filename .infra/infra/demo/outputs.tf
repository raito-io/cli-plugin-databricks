output "catalog" {
  value = databricks_catalog.master_catalog
}

output "tables" {
  value = [
    databricks_sql_table.awsbuildversion.id,
    databricks_sql_table.databaselog.id,
    ...
    databricks_sql_table.bill_of_materials.id,
    databricks_sql_table.culture.id,
    databricks_sql_table.document.id,
    databricks_sql_table.illustration.id,
